 ...
 **************************************************************** **/
	function _panels() {
	  console.log("Start ...........");
		// Panel Collapse
  jQuery(document).on("click", "#middle div.panel ul.options>li>a.panel_colapse", function(e) {
    e.preventDefault();
		...
		// Panel Close
		jQuery(document).on("click", "#middle div.panel ul.options>li>a.panel_close", function(e) {
			e.preventDefault();
		...
		// Panel Fullscreen
		jQuery(document).on("click", "#middle div.panel ul.options>li>a.panel_fullscreen", function(e) {
			e.preventDefault();
			var panel 			= jQuery(this).closest('div.panel'),
