...
jQuery(document).ready(function () {
  ...
  jQuery("#dashboardSwitcher, #showSwitcher").removeClass('hide');

  jQuery(document).on('click', "#hideSwitcher, #showSwitcher", function () {

    if (jQuery("#showSwitcher").is(":visible")) {

      var _identifier = "#showSwitcher";
      jQuery("#dashboardSwitcher").animate({
        "margin-left": "0px"
      }, 500).show();
      ...
      var _identifier = "#dashboardSwitcher";
...
jQuery(document).on('click', "select#headerLayout", function () {
