...
@Component({
  selector: 'app-view-reorder-conf',
  templateUrl: './view-reorder-conf.component.html',
  styleUrls: ['./view-reorder-conf.component.scss'],
  providers: [BuildersService]
})
export class ViewReorderConfComponent implements OnInit {
