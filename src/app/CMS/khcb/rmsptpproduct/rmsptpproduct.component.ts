...
import { rmsptpproductService } from "./rmsptpproductService";
import { PublicSetting, PublicShared } from "../../../models/PublicShared";
@Component({
  selector: 'app-rmsptpproduct',
  templateUrl: './rmsptpproduct.component.html',
  styleUrls: ['./rmsptpproduct.component.scss'],
  providers: [PublicSetting, rmsptpproductService]
})
export class RmsptpproductComponent implements OnInit {
  YearCode: any;
  Client: any;
  PERIODID;
  ...
  constructor(private Server: rmsptpproductService, public SharedData: PublicSetting) {
