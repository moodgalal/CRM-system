...
import { rmsptpcollectstageService } from "./rmsptpcollectstageService";
import { PublicSetting, PublicShared } from "../../../models/PublicShared";

@Component({
  selector: 'app-rmsptpcollectstage',
  templateUrl: './rmsptpcollectstage.component.html',
  styleUrls: ['./rmsptpcollectstage.component.scss'],
  providers: [PublicSetting, rmsptpcollectstageService]
})
export class RmsptpcollectstageComponent implements OnInit {
  ...
  constructor(private Server: rmsptpcollectstageService, public SharedData: PublicSetting) {
